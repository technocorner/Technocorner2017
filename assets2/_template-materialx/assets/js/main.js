...
// 	// $('.news-scrollbar').mousewheel(function(event) {
//  //    	event.preventDefault();
// 	// });
//    $(document).ready(function() {

//      var element = $('.news-scrollbar').jScrollPane({
//             showArrows: false,
...
//      jQuery('.scroll-style').jScrollPane({mouseWheelSpeed : 10});

//  	});
//  });
// $(".news-scrollbar").bind("mousewheel", function() {
//     return true;
// });
//       $('.news-scrollbar').each(function(){
