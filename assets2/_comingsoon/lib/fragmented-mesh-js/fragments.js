...
var Particle = function() {
    ...
    this.age = 0;
    this.checkOn = Math.floor(Math.random() * 5);
    ...
    this.position.y = random(-150,150);
...
function init3D() {
    ...
    scene.fog = new THREE.FogExp2( 0xffca00, 0.03 );
    
    // Lights
    
    var lightA = new THREE.AmbientLight( 0x0335ba );
    
    var lightB = new THREE.DirectionalLight( 0xffca00 );
    lightB.position.set(1,1,1);
    
    var lightC = new THREE.DirectionalLight( 0xffca00 );
